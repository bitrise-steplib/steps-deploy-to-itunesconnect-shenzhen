...
echo_string_to_formatted_output "The app (.ipa) was successfully uploaded to iTunes Connect, you should see it in the *Prerelease* section on the app's iTunes Connect page!"
